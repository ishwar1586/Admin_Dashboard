...
const PersonalInformation = () => {
  ...
  const handleChange = (e, i) => {
    if (
      ...
      const Wife = [...personal.Wife];
      Wife[i][e.target.name] = e.target.value;
      setPersonal({ ...personal, Wife });
      console.log("Wife", personal.Wife);
    } else if (
      [
        "BName",
        "BDOB",
      ...
      const Brother = [...personal.Brother];
      Brother[i][e.target.name] = e.target.value;
      console.log("Insurance", Brother);
      setPersonal({ ...personal, Brother });
    } else if (
      [
        "SiName",
        "SiDOB",
      ...
      const Sister = [...personal.Sister];
      Sister[i][e.target.name] = e.target.value;
      console.log("Insurance", Sister);
      setPersonal({ ...personal, Sister });
    } else if (
      [
        "sName",
        "sDOB",
      ...
      const Sun = [...personal.Sun];
      Sun[i][e.target.name] = e.target.value;
      console.log("Insurance", Sun);
      setPersonal({ ...personal, Sun });
    } else if (
      [
        "DName",
        "DDOB",
      ...
      const Daughter = [...personal.Daughter];
      Daughter[i][e.target.name] = e.target.value;
      console.log("Insurance", Daughter);
      setPersonal({ ...personal, Daughter });
    } else if (
      [
       "LPolicyhName",
        "LPolicyTableNumber",
      ...
      const Insurance = [...personal.Insurance];
      Insurance[i][e.target.name] = e.target.value;
      console.log("Insurance", Insurance);
      setPersonal({ ...personal, Insurance });
    } else if (
      [
        "MPersonal",
        "MCompany",
      ...
      const Medical = [...personal.Medical];
      Medical[i][e.target.name] = e.target.value;
      console.log("Insurance", Medical);
      setPersonal({ ...personal, Medical });
    } else if (
      [
        "GVehicleNumber",
        "GPolicyNumber",
      ...
      const Gernal = [...personal.Gernal];
      Gernal[i][e.target.name] = e.target.value;
      console.log("Insurance", Gernal);
      setPersonal({ ...personal, Gernal });
    } else {
  ...
  const handleFile =(e,i)=>{
      ...
      const Wife = [...personal.Wife];
      Wife[i][e.target.name] = e.target.files[0];
      setPersonal({ ...personal, Wife });
      console.log("Wife", personal.Wife);
    } else if (
      [
      ...
      const Brother = [...personal.Brother];
      Brother[i][e.target.name] = e.target.files[0];
      console.log("Insurance", Brother);
      setPersonal({ ...personal, Brother });
    } else if (
      [
      ...
      const Sister = [...personal.Sister];
      Sister[i][e.target.name] = e.target.files[0];
      console.log("Insurance", Sister);
      setPersonal({ ...personal, Sister });
    } else if (
      [
      ...
      const Sun = [...personal.Sun];
      Sun[i][e.target.name] = e.target.files[0];
      console.log("Insurance", Sun);
      setPersonal({ ...personal, Sun });
    } else if (
      [
      ...
      const Daughter = [...personal.Daughter];
      Daughter[i][e.target.name] = e.target.files[0];
      console.log("Insurance", Daughter);
      setPersonal({ ...personal, Daughter });
    } else {
      console.log("personal", personal);
      setPersonal({ ...personal, [e.target.name]: e.target.files[0] });
    }
  }
  ...
  const handelValue = async(e) => {
    ...
    // setUser1(personal);
console.log('user1',personal)
// setShow(false);
    formData.set('Entrydate',personal.Entrydate)
    formData.set('ReferenceName',personal.ReferenceName)
    formData.set('PName',personal.PName)
    formData.set('FileNumber',personal.FileNumber)
    formData.set('PDOB',personal.PDOB)
    formData.set('PQualification',personal.PQualification)
    formData.set('Job',personal.Job)
    formData.set('Income',personal.Income)
    formData.set('Address',personal.Address)
    formData.set('PFatherName',personal.PFatherName)
    formData.set('PMotherName',personal.PMotherName)
    formData.set('PMobile',personal.PMobile)
    formData.set('POtherMobileNumber',personal.POtherMobileNumber)
    formData.set('PEmailId',personal.PEmailId)
    formData.set('PWeight',personal.PWeight)
    formData.set('PHeight',personal.PHeight)
    formData.set('PCertificate',personal.PCertificate)
    formData.set('PIdProof',personal.PIdProof)
    formData.set('PAddressProof',personal.PAddressProof)
    formData.set('PPhoto',personal.PPhoto)
    personal.Wife.forEach((Wife, index) => {
      formData.set(`Wife[${index}][name]`, Wife.Name);
      formData.set(`Wife[${index}][DOB]`, Wife.DOB);
      formData.set(`Wife[${index}][Qualification]`,Wife.Qualification);
      formData.set(`Wife[${index}][FatherName]`,Wife.FatherName);
      formData.set(`Wife[${index}][MotherName]`,Wife.MotherName);
      formData.set(`Wife[${index}][Mobile]`,Wife.Mobile);
      formData.set(`Wife[${index}][OtherMobileNumber]`, Wife.OtherMobileNumber);
      formData.set(`Wife[${index}][EmailId]`, Wife.EmailId);
      formData.set(`Wife[${index}][Weaight]`, Wife.Weaight);
      formData.set(`Wife[${index}][Height]`, Wife.Height);
      formData.set(`Wife[${index}][Certificate]`, Wife.Certificate);
      formData.set(`Wife[${index}][IdProof]`, Wife.IdProof);
      formData.set(`Wife[${index}][AddressProof]`, Wife.AddressProof);
      formData.set(`Wife[${index}][Photo]`, Wife.Photo);
    });
  ...
  const addFormFields = (add) => {
    const personalCopy = { ...personal };
    if (add === "Wife") {
      const currentTaskList = personalCopy[add];
      personalCopy[add] = [
        ...currentTaskList,
        {
          index: Math.random(),
  ...
  const Delete = () => {};
  const removeFormFields = (i, d) => {
    const personalCopy = { ...personal };
    console.log("a", personalCopy);
    console.log("b", d);
    const currentTaskList = personalCopy[d];
    console.log("first", currentTaskList);
    currentTaskList.splice(i, 1);
    console.log("Second", currentTaskList);
    console.log("Secondi", i);
    setPersonal({ ...personal, [currentTaskList]: "" });
  };
          ...
          <Modal size={"md"} show={show} onHide={handleCloses}>
            ...
            <Modal.Body>
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-4">
                        ...
                        <div className="new_location_modal">
                          <input
                            ...
                            value={personal.POtherMobileNumber}
                            onChange={handleChange}
                          />
                        </div>
                      </div>
              ...
              <Accordion className="aces">
                ...
                <AccordionDetails>
                  <Typography>
                    {Array.isArray(personal.Wife) &&
                      personal.Wife.map((ele, index) => {
                        return (
                          <>
